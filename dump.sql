...
--
-- Name: account; Type: TABLE; Schema: public; Owner: sampleuser
--
...
ALTER TABLE public.account OWNER TO sampleuser;

--
-- Name: account_user_id_seq; Type: SEQUENCE; Schema: public; Owner: sampleuser
--
...
ALTER TABLE public.account_user_id_seq OWNER TO sampleuser;

--
-- Name: account_user_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: sampleuser
--
...
--
-- Name: account user_id; Type: DEFAULT; Schema: public; Owner: sampleuser
--
...
--
-- Data for Name: account; Type: TABLE DATA; Schema: public; Owner: sampleuser
--
...
--
-- Name: account_user_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sampleuser
--
...
--
-- Name: account account_pkey; Type: CONSTRAINT; Schema: public; Owner: sampleuser
--
